...
public class MoonstillnessshiyongProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if ((entity.getCapability(HikariNoSanyouseiModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new HikariNoSanyouseiModVariables.PlayerVariables())).sanyousei == 2) {
			...
			if (entity instanceof Player _player && !_player.level.isClientSide())
				_player.displayClientMessage(new TextComponent("\u6708\u5149\u300CMoon Stillness\u300D"), (true));
			...
			if (entity instanceof Player _player)
				_player.getCooldowns().addCooldown(HikariNoSanyouseiModItems.SC_MOONSTILLNESS.get(), 1000);
			new Object() {
				private int ticks = 0;
				...
				private void run() {
					...
					{
						ItemStack _ist = new ItemStack(HikariNoSanyouseiModItems.SC_MOONSTILLNESS.get());
