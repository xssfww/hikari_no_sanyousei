...
import net.mcreator.hikarinosanyousei.procedures.DeskZaiFangKuaiShangYouJianProcedure;
...
public class DeskBlock extends Block {
	...
	public InteractionResult use(BlockState blockstate, Level world, BlockPos pos, Player entity, InteractionHand hand, BlockHitResult hit) {
		...
		DeskZaiFangKuaiShangYouJianProcedure.execute(world, x, y, z, entity);
		return InteractionResult.SUCCESS;
	}

	@OnlyIn(Dist.CLIENT)
	public static void registerRenderLayer() {
		ItemBlockRenderTypes.setRenderLayer(HikariNoSanyouseiModBlocks.DESK.get(), renderType -> renderType == RenderType.cutout());
	}
}
