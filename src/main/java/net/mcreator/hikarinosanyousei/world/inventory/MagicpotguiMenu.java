...
public class MagicpotguiMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public MagicpotguiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(HikariNoSanyouseiModMenus.MAGICPOTGUI, id);
