...
public class MinihakkeroDrakSparkItem extends Item {
	public MinihakkeroDrakSparkItem() {
	...
	public void releaseUsing(ItemStack itemstack, Level world, LivingEntity entityLiving, int timeLeft) {
		if (!world.isClientSide() && entityLiving instanceof ServerPlayer entity) {
			...
			if (true) {
				MinihakkeroDrakSparkEntity entityarrow = MinihakkeroDrakSparkEntity.shoot(world, entity, world.getRandom(), 6f, 20, 4);
