package net.mcreator.hikarinosanyousei.item.renderer;
...
import net.mcreator.hikarinosanyousei.item.model.HakuroukennewItemModel;
import net.mcreator.hikarinosanyousei.item.HakuroukennewItem;
import net.mcreator.hikarinosanyousei.interfaces.RendersPlayerArms;
...
public class HakuroukennewItemRenderer extends GeoItemRenderer<HakuroukennewItem> implements RendersPlayerArms {
	public HakuroukennewItemRenderer() {
		super(new HakuroukennewItemModel());
	}

	@Override
	public RenderType getRenderType(HakuroukennewItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
		return RenderType.entityTranslucent(getTextureLocation(animatable));
	}

	static {
		AnimationController.addModelFetcher(animatable -> {
			if (animatable instanceof HakuroukennewItem) {
				Item item = (Item) animatable;
				BlockEntityWithoutLevelRenderer ister = new HakuroukennewItemRenderer();
	...
	protected HakuroukennewItem animatable;
	...
	@Override
	public void render(GeoModel model, HakuroukennewItem animatable, float partialTicks, RenderType type, PoseStack matrixStackIn, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, int packedLightIn, int packedOverlayIn, float red,
	...
	@Override
	public void render(HakuroukennewItem animatable, PoseStack stack, MultiBufferSource bufferIn, int packedLightIn, ItemStack itemStack) {
	...
	@Override
	public ResourceLocation getTextureLocation(HakuroukennewItem instance) {
		return super.getTextureLocation(instance);
	}

	@Override
	public Integer getUniqueID(HakuroukennewItem animatable) {
