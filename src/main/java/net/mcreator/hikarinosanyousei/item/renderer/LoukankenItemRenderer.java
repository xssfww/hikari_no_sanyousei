...
import net.mcreator.hikarinosanyousei.item.model.LoukankenItemModel;
...
public class LoukankenItemRenderer extends GeoItemRenderer<LoukankenItem> implements RendersPlayerArms {
	public LoukankenItemRenderer() {
		super(new LoukankenItemModel());
	}

	@Override
	public RenderType getRenderType(LoukankenItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
		return RenderType.entityTranslucent(getTextureLocation(animatable));
	}

	static {
		AnimationController.addModelFetcher(animatable -> {
			if (animatable instanceof LoukankenItem) {
				Item item = (Item) animatable;
				BlockEntityWithoutLevelRenderer ister = new LoukankenItemRenderer();
	...
	protected LoukankenItem animatable;
	...
	@Override
	public void render(GeoModel model, LoukankenItem animatable, float partialTicks, RenderType type, PoseStack matrixStackIn, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, int packedLightIn, int packedOverlayIn, float red,
	...
	@Override
	public void render(LoukankenItem animatable, PoseStack stack, MultiBufferSource bufferIn, int packedLightIn, ItemStack itemStack) {
	...
	@Override
	public ResourceLocation getTextureLocation(LoukankenItem instance) {
		return super.getTextureLocation(instance);
	}

	@Override
	public Integer getUniqueID(LoukankenItem animatable) {
